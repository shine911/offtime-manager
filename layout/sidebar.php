...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item <? echo setActive('index') ?>">
    <a class="nav-link" href="index.php">
        <i class="fas fa-fw fa-tachometer-alt"></i>
        <span>Thống kê</span></a>
    </li>

    <li class="nav-item <? echo setActive('bangphancong') ?>">
    ...
    <!-- Nav Item - Calendar -->
    <li class="nav-item <? echo setActive('calendar') ?>">
    ...
    <li class="nav-item <? echo setActive('themmon') ?>">
    <a class="nav-link" href="themmon.php">
        <i class="fas fa-fw fa-table"></i>
        <span>Thêm môn</span></a>
    </li>

    <li class="nav-item <? echo setActive('bangmonhoc') ?>">
    <a class="nav-link" href="bangmonhoc.php">
        <i class="fas fa-fw fa-table"></i>
        <span>Bảng môn học</span></a>
    </li>

    <li class="nav-item <? echo setActive('phancong') ?>">
